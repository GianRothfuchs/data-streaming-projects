...
class Weather(Producer):
    ...
    def run(self, month):
        ...
        #pecify the Avro schemas and verify that you are using the correct Content-Type header.
        ...
        resp = requests.post(
           ...
           data=json.dumps(
               {
                   "key_schema": json.dump(Weather.key_schema),
                   "value_schema": json.dump(Weather.value_schema),
                   "records": [
